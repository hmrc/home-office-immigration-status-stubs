...
trait JsonMatchers {
  ...
  def haveProperty[T: Reads](name: String)(implicit classTag: ClassTag[T]): Matcher[JsObject] =
    (obj: JsObject) =>
  ...
  def haveProperty[T: Reads](name: String, matcher: Matcher[T])(implicit classTag: ClassTag[T]): Matcher[JsObject] =
    (obj: JsObject) =>
      (obj \ name).asOpt[T] match {
        case Some(value) =>
          matcher(value) match {
  ...
  def havePropertyArrayOf[T: Reads](name: String)(implicit classTag: ClassTag[T]): Matcher[JsObject] =
    (obj: JsObject) =>
  ...
  def havePropertyArrayOf[T: Reads](name: String, matcher: Matcher[T])(implicit
    classTag: ClassTag[T]
  ): Matcher[JsObject] =
    (obj: JsObject) =>
      (obj \ name).asOpt[JsArray] match {
